# dourec
python run_seq.py --dataset='Amazon_Beauty' --gpu_id=0  --metrics="['Recall', 'NDCG', 'MRR']" --valid_metric="MRR@10" --train_batch_size=1024 --lmd=0.1 --lmd_sem=0.1 --model='DuoRec' --contrast='us_x' --sim='dot' --tau=1 --nproc=2 --epochs=100 --data_path="./recbole/dataset"
...
python run_seq.py --dataset='Amazon_Beauty'  --nprobe=1 --attn_tau=1.0 --dropout_rate=0.5 --alpha=0.5 --beta=1.0 --top_k=10 --metrics="['Recall', 'NDCG']" --valid_metric="Recall@10"  --train_batch_size=1024 --model='RaSeRec' --sim='dot' --tau=1 --nproc=2 --epochs=100 --data_path="./recbole/dataset" --pre_training_ckt="./log/DuoRec/Amazon_Beauty/bs1024-lmd0.1-sem0.1-us_x-Sep-17-2025_17-26-18-lr0.001-l20-tau1-dot-DPh0.5-DPa0.5/model.pth"
#TTAREc
