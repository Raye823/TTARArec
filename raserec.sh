...
#bert
python run_basic.py --dataset Amazon_Beauty --config_file bert4rec.yaml --model BERT4Rec
python run_basic.py --dataset Amazon_Sports_and_Outdoors --config_file bert4rec.yaml --model BERT4Rec
#TTAREc
python run_ttararec.py --dataset Amazon_Beauty --pre_training_ckt="./log/DuoRec/Amazon_Beauty/bs1024-lmd0.1-sem0.1-us_x-Mar-19-2025_21-16-57-lr0.001-l20-tau1-dot-DPh0.5-DPa0.5/model.pth"
python run_ttararec.py --dataset Amazon_Sports_and_Outdoors --pre_training_ckt="./log/DuoRec/Amazon_Beauty/bs1024-lmd0.1-sem0.1-us_x-Mar-19-2025_21-16-57-lr0.001-l20-tau1-dot-DPh0.5-DPa0.5/model.pth"
#raserec
