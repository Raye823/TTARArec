...
#SASRec
python run_sasrec.py  --dataset Amazon_Beauty
python run_duorec.py --dataset Amazon_Beauty --config_file sasrec.yaml --model SASRec
python run_sasrec.py  --dataset Amazon_Sports_and_Outdoors
#TTAREc
python run_ttararec.py --dataset Amazon_Beauty 
python run_ttararec.py --dataset Amazon_Sports_and_Outdoors
#raserec
...
#bert
python run_duorec.py --dataset=Amazon_Beauty --config_file=bert4rec.yaml --model=BERT4Rec